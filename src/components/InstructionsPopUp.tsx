  ...
  const slides = [
    {
      ...
      description: (
        <>
			The landing page consists of several <b>task groups</b> (e.g., Welcome to B-PASS, Access and Equipment, and Travel and Expense Management).  When you click on a task group, you are taken to a page with all the tasks associated with that task group.
        </>
      ),
	...
	},
	{
	  ...
	  {
		header: 'Resources Bank',
		description: (
		  <>
			The resources page is <b>still under construction</b>. Some resources will be linked at a later time. Users will be able to go directly to the resources page to access any of the onboarding resources included in the application. This is designed to make it <b>easier to locate onboarding resources</b>.

		  </>
		),
		image: resourcesPageImage
	  },
	  {
		header: 'AI Onboarding Assistant',
		description: (
		  <>
			The onboarding assistant is an <b>AI agent trained on B-PASS onboarding documents</b>. It can assist users with <b>general and team-specific onboarding questions</b>. There are also links to the onboarding assistant from each task group page. The goal of this feature is to save time for incoming and current team members.
		  </>
		),
		image: chatPageImage
	  },
